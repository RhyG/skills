...
Ask the user for the PRD Jira ticket number (or URL). Fetch it with the Jira MCP. Read and internalize the full PRD content (with all comments).
...
For each approved slice, create a Jira ticket using the Jira MCP. Use the issue body template below.
